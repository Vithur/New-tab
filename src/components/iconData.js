...
export const ICON_CATEGORIES = [
  { id: "all", label: "全部图标", icon: "ri-grid-fill" },
  { id: "daily", label: "日常生活", icon: "ri-sun-line" },
  { id: "fitness", label: "健身", icon: "ri-heart-pulse-line" },
  { id: "work", label: "工作与编程", icon: "ri-code-s-slash-line" },
  { id: "study", label: "学习", icon: "ri-book-open-line" },
  { id: "leisure", label: "兴趣休闲", icon: "ri-gamepad-line" },
  { id: "social", label: "社交与应用", icon: "ri-chat-3-line" },
];
